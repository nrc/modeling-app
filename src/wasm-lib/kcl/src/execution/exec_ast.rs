...
use crate::{
    ...
    execution::{
        ...
        BodyType, ExecState, ExecutorContext, KclValue, Metadata, TagEngineInfo, TagIdentifier,
    },
    parsing::ast::types::{
        ArrayExpression, ArrayRangeExpression, BinaryExpression, BinaryOperator, BinaryPart, BodyItem, CallExpression,
        CallExpressionKw, Expr, FunctionExpression, IfExpression, ImportSelector, ItemVisibility, LiteralIdentifier,
        LiteralValue, MemberExpression, MemberObject, Node, NodeRef, NonCodeValue, ObjectExpression, PipeExpression,
...
use super::{state::ModuleState, MemoryFunction, ProgramMemory};
...
impl ExecutorContext {
    ...
    async fn exec_module(
        ...
        let result = self
            .exec_program(&info.parsed.unwrap(), exec_state, crate::execution::BodyType::Root)
            .await;
