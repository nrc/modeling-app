...
use kcl_lib::{bust_cache, exec::IdGenerator, CoreDump, EngineManager, ModuleId, Point2d, Program};
...
pub async fn execute(
    ...
    match ctx.run_with_caching(program, program_memory_override).await {
